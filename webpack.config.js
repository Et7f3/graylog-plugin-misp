...
module.exports = new PluginWebpackConfig(path.resolve(__dirname), 'com.airbus_cyber_security.graylog.LoggingAlertPlugin', loadBuildConfig(path.resolve(__dirname, './build.config')), {
